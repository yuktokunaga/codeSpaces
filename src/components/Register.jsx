...
function Register({ onBack, onGoLogin }) {
    ...
    <div className="login-page">
      ...
      <div className="login-card">
        <div className="login-header">
          ...
          <p className="login-tagline">{t.registerSubtitle}</p>
        </div>

        <form className="login-form" onSubmit={handleSubmit}>
          <div className="form-group">
            <label className="form-label">{t.registerName}</label>
          ...
          <div className="form-group">
            <label className="form-label">{t.registerConfirmPassword}</label>
            <div className="input-wrapper">
              <svg className="input-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
                <path d="M7 11V7a5 5 0 0 1 10 0v4" />
          ...
          <label className="remember-me" style={{ marginBottom: '20px' }}>
            <input
              type="checkbox"
              checked={agreeTerms}
        ...
        <div className="login-footer">
          <p>
            {t.haveAccount}{' '}
            <a href="#" className="signup-link" onClick={(e) => { e.preventDefault(); onGoLogin(); }}>{t.loginButton}</a>
          </p>
